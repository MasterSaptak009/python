...
%The path for the grayscale bmp cover image
id = fopen('C:\Users\Devil\Desktop\Python codes\hidden_msg.txt', 'r');
spec = '%c';
...
imwrite(s,'C:\Users\Devil\Desktop\Python codes\encodedImg.bmp','bmp'); 
